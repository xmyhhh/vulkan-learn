...
void MultisamplingApplication::run()
{
...
void MultisamplingApplication::drawFrame()
{
...
void MultisamplingApplication::mainLoop()
{
...
void MultisamplingApplication::createGraphicsPipeline()
{
...
void MultisamplingApplication::createVertexBuffer()
{
...
void MultisamplingApplication::createIndexBuffer()
{
...
void MultisamplingApplication::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void MultisamplingApplication::createDescriptorSetLayout()
{
...
void MultisamplingApplication::createUniformBuffers()
{
...
void MultisamplingApplication::updateUniformBuffer(uint32_t currentImage)
{
...
void MultisamplingApplication::createCommandBuffer()
{
...
void MultisamplingApplication::createSyncObjects()
{
...
void MultisamplingApplication::createDescriptorPool()
{
...
void MultisamplingApplication::createDescriptorSets()
{
...
void MultisamplingApplication::createTextureImage()
{
	...
	createImage(
		...
		VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, //texture image as both the source and destination of a transfer
...
void MultisamplingApplication::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
}

void MultisamplingApplication::createTextureSampler()
{
	...
	samplerInfo.mipLodBias = 1.0f; // Optional
...
void MultisamplingApplication::createRenderPass()
{
	...
	VkAttachmentDescription colorAttachment{
		...
		.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE,
		.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED,
		// changed the finalLayout from VK_IMAGE_LAYOUT_PRESENT_SRC_KHR to VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL. That's because multisampled images cannot be presented directly
...
void MultisamplingApplication::createFramebuffers()
{
...
VkFormat MultisamplingApplication::findDepthFormat() {
...
void MultisamplingApplication::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
VkFormat MultisamplingApplication::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
void MultisamplingApplication::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
...
void MultisamplingApplication::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void MultisamplingApplication::cleanup()
{
